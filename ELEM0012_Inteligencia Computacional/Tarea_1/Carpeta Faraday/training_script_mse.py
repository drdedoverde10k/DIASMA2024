...
# Usar solo 100 datos al azar para pruebas locales si `data_local` es True
if data_local:
...
# Convertir etiquetas a formato one-hot para MSE
...
def train_model(model, train_loader, val_loader, criterion, optimizer, epochs=1000, early_stopping_patience=15):
    ...
    plt.tight_layout()
    #plt.savefig('training_results_mse.png', dpi=300)  # Guardar el gráfico
    plt.savefig('/home/fespinoza/proyecto_ic/mlp_mse_results/training_results_mse.png', dpi=300)  # Guardar el gráfico
    #plt.show()
...
def plot_confusion_matrix(model, val_loader, classes):
    ...
    with torch.no_grad():
        for inputs, labels in val_loader:
            ...
            all_labels.extend(labels.argmax(dim=1).cpu().numpy())  # Convertir a enteros
    ...
    #plt.savefig('confusion_matrix_fixed.png', dpi=300)  # Guardar en alta resolución
    plt.savefig('/home/fespinoza/proyecto_ic/mlp_mse_results/confusion_matrix_mse.png', dpi=300)  # Guardar en alta resolución
    #plt.show()
...
def plot_roc_curve(model, val_loader, classes):
    ...
    plt.legend(loc="best")
    # Guardar los gráficos como archivo PNG
    #plt.savefig('roc_curve_mse.png', dpi=300) # Guardar en alta resolución
    plt.savefig('/home/fespinoza/proyecto_ic/mlp_mse_results/roc_curve_mse.png', dpi=300) # Guardar en alta resolución
    #plt.show()
    #plt.close()  # Cerrar la figura actual
...
def plot_det_curve(model, val_loader, classes):
    ...
    # Guardar los gráficos como archivo PNG
    #plt.savefig('det_curve_mse.png', dpi=300) # Guardar en alta resolución
    plt.savefig('/home/fespinoza/proyecto_ic/mlp_mse_results/det_curve_mse.png', dpi=300) # Guardar en alta resolución
    #plt.show()
    #plt.close()  # Cerrar la figura actual
...
# Comentario Final
print("Ha terminado el proceso de mlp con MSE")