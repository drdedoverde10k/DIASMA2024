...
def train_model(model, train_loader, val_loader, criterion, optimizer, epochs=1000, early_stopping_patience=15):
    ...
    plt.savefig('/home/fespinoza/proyecto_ic/mlp_xel_results/training_results_xel.png', dpi=300)  # Guardar en alta resolución
    #plt.show()
...
def plot_confusion_matrix(model, val_loader, classes):
    ...
    # Guardar los gráficos como archivo PNG
    plt.savefig('/home/fespinoza/proyecto_ic/mlp_xel_results/consusion_matrix_celoss.png', dpi=300) # Guardar en alta resolución
    #plt.show()
...
def plot_roc_curve(model, val_loader, classes):
    ...
    plt.legend(loc="best")
    # Guardar los gráficos como archivo PNG
    plt.savefig('/home/fespinoza/proyecto_ic/mlp_xel_results/roc_curve_cross_e.png', dpi=300) # Guardar en alta resolución
    #plt.show()
    #plt.close()  # Cerrar la figura actual
...
def plot_det_curve(model, val_loader, classes):
    ...
    # Guardar los gráficos como archivo PNG
    plt.savefig('/home/fespinoza/proyecto_ic/mlp_xel_results/det_curve_cross_e.png', dpi=300) # Guardar en alta resolución
    #plt.show()
    #plt.close()  # Cerrar la figura actual
...
# Comentario Final
print("Ha terminado el Proceso de mlp con XEL")
